...
export default class Vstx extends BaseIllustration {
  ...
  <path fill="#c8c8c8" d="M23 20.05V17h-2v-2.05a2.5 2.5 0 1 0-1 0V17h-2v-2h-5v5h5v-2h4v2.05a2.5 2.5 0 1 0 1 0zm-4-7.55a1.5 1.5 0 1 1 1.5 1.5 1.502 1.502 0 0 1-1.5-1.5zM17 19h-3v-3h3zm5.5 5a1.5 1.5 0 1 1 1.5-1.5 1.502 1.502 0 0 1-1.5 1.5z" />
