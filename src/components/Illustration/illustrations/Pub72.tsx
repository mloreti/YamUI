...
export default class Pub extends BaseIllustration {
  render() {
    return (
      ...
      >
        <defs>
    <linearGradient id="a" x1={57} x2={57} y1="24.844" y2="20.146" gradientUnits="userSpaceOnUse">
    ...
    <linearGradient id="e" x1="11.467" x2="63.639" y1="7.804" y2="69.981" gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#fff" stopOpacity={0} />
  ...
  <path fill="#c8c8c8" d="M57 38v17H34V39h23m2-2H32v20h27z" />
  <path fill="#c8c8c8" d="M48 26v11H32V26h16m2-2H30v15h20V24z" />
  <path fill="#7dbab2" d="M47 41h7v2h-7z" />
  <path fill="#c8c8c8" d="M37 41h7v12h-7z" />
  <path fill="#7dbab2" d="M37 28h8v2h-8zm0 5h8v2h-8zm10 13h7v2h-7zm0 5h7v2h-7z" />
  <path fill="#0b7669" d="M6 25l31-5v40L6 55V25z" />
  <path fill="#fff" d="M19.007 42.8V49H15V31h6.277Q28 31 28 36.736a5.534 5.534 0 0 1-1.93 4.388 7.585 7.585 0 0 1-5.153 1.675zm0-8.687v5.61h1.575q3.2 0 3.2-2.836 0-2.774-3.2-2.774z" />
  <path fill="url(#a)" d="M50 20h14v5H50z" />
  ...
  <path fill="url(#e)" d="M52 4H16v19.387L6 25v30l10 1.613V68h50V18z" />
      </svg>
    );
  }
}
