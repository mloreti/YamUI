...
export default class Docx extends BaseIllustration {
  ...
  <path fill="#2b579a" d="M3 11l13-2v18L3 25V11z" />
  <path fill="#fff" d="M14.312 15l-1.804 7h-1.704l-1.133-4.49a3.834 3.834 0 0 1-.11-.787h-.018a4.876 4.876 0 0 1-.124.786L8.258 22H6.482l-1.795-7h1.68l.962 4.662a5.715 5.715 0 0 1 .09.8h.03a3.966 3.966 0 0 1 .137-.82L8.824 15h1.647l1.119 4.7a5.894 5.894 0 0 1 .11.753h.018a5.143 5.143 0 0 1 .1-.781L12.761 15z" />
