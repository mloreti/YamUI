...
export default class Model extends BaseIllustration {
  ...
  <path fill="#c7e0f4" d="M20 17v5.333l-8-2.666L20 17z" />
  <path fill="#69afe5" d="M20 17v5.333l8-2.666L20 17z" />
  <path fill="#0078d7" d="M20 22.333l8-2.666v10.666L20 33V22.333z" />
