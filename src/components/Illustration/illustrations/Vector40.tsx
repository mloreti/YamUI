...
export default class Vector extends BaseIllustration {
  ...
  <path fill="#0078d7" d="M14 30v3h-3v-3h3m1-1h-5v5h5v-5zM29 15v3h-3v-3h3m1-1h-5v5h5v-5zM25 29l-1 5-4-10 10 4-5 1z" />
  <path fill="#c8c8c8" d="M13.993 24.234a4.518 4.518 0 0 1-.78-.683A12.877 12.877 0 0 0 12.17 27h1.01a11.9 11.9 0 0 1 .813-2.766zM20.234 17.993A11.9 11.9 0 0 1 23 17.18v-1.01a12.877 12.877 0 0 0-3.449 1.042 4.518 4.518 0 0 1 .683.78z" />
  <circle cx="16.5" cy="20.5" r="2.5" fill="#0078d7" />
