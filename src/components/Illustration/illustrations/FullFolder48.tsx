...
export default class FullFolder extends BaseIllustration {
  render() {
    return (
      ...
      >
        <defs>
    <linearGradient id="a" x1="35.231" x2="34.241" y1="8.145" y2="19.459" gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#828282" stopOpacity={0} />
      <stop offset=".859" stopColor="#454545" stopOpacity=".117" />
      <stop offset={1} stopOpacity=".25" />
    </linearGradient>
    <linearGradient id="b" x1="7.937" x2="37.601" y1="9.857" y2="45.209" gradientUnits="userSpaceOnUse">
  ...
  <path fill="url(#a)" d="M29 9l-5 5 5 5h16V9H29z" />
  <path fill="#fff" d="M5 11h38v28H5z" />
  <path fill="#a6a6a6" d="M3 39V14h21l5 5h16v20H3z" />
  <path fill="url(#b)" d="M3 39V14h21l5 5h16v20H3z" />
