...
export default class FullFolder extends BaseIllustration {
  render() {
    return (
      ...
      >
        <defs>
    <linearGradient id="a" x1="23.444" x2="22.839" y1="5.426" y2="12.336" gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#828282" stopOpacity={0} />
      <stop offset=".859" stopColor="#454545" stopOpacity=".117" />
      <stop offset={1} stopOpacity=".25" />
    </linearGradient>
    <linearGradient id="b" x1="5.292" x2="25.231" y1="6.238" y2="30.001" gradientUnits="userSpaceOnUse">
  ...
  <path fill="url(#a)" d="M19 6l-3 3 3 3h11V6H19z" />
  ...
  <path fill="url(#b)" d="M2 26V9h14l3 3h11v14H2z" />
      </svg>
    );
  }
}
