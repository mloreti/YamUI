...
export default class Sway extends BaseIllustration {
  render() {
    ...
    <linearGradient id="d" x1="25.966" x2="26.798" y1="65.803" y2="58.018" gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#828282" stopOpacity={0} />
      <stop offset=".862" stopColor="#303030" stopOpacity=".126" />
      <stop offset={1} stopOpacity=".2" />
    </linearGradient>
    <linearGradient id="e" x1="21.5" x2="21.5" y1="57.75" y2="20.167" gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#fff" stopOpacity={0} />
