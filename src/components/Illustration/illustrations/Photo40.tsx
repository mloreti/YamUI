...
export default class Photo extends BaseIllustration {
  ...
  <path fill="#7dbab2" d="M37 29.707v-1.414l-10.5-10.5-5.5 5.5-9.5-9.5-8.5 8.5v1.414l8.5-8.5L28.293 32h1.414l-8-8 4.793-4.793 10.5 10.5z" />
  <path fill="#f5ba9d" d="M31.5 12a1.5 1.5 0 1 1-1.5 1.5 1.502 1.502 0 0 1 1.5-1.5m0-1a2.5 2.5 0 1 0 2.5 2.5 2.5 2.5 0 0 0-2.5-2.5z" />
