...
export default class Vector extends BaseIllustration {
  ...
  <path fill="#0078d7" d="M45 52l-3 9-7-19 19 7-9 3zm7-25v5h-5v-5h5m2-2h-9v9h9v-9zM25 54v5h-5v-5h5m2-2h-9v9h9v-9z" />
  <circle cx="28.5" cy="35.5" r="4.5" fill="#0078d7" />
  <path fill="#c8c8c8" d="M25.742 41.377a6.513 6.513 0 0 1-1.666-1.128A23.845 23.845 0 0 0 21.089 50h2.006a21.835 21.835 0 0 1 2.647-8.623zM43 30.095v-2.006a23.849 23.849 0 0 0-9.751 2.987 6.517 6.517 0 0 1 1.128 1.666A21.837 21.837 0 0 1 43 30.095z" />
