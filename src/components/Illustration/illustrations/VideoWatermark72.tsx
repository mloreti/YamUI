...
export default class VideoWatermark extends BaseIllustration {
  render() {
    return (
      ...
      >
        <defs>
    <linearGradient id="a" x1="11.453" x2="60.547" y1="6.746" y2="65.254" gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#fff" stopOpacity={0} />
      <stop offset=".862" stopColor="#5e5e5e" stopOpacity=".063" />
      <stop offset={1} stopOpacity=".1" />
    </linearGradient>
    <linearGradient id="b" x1="30.5" x2="63.5" y1="41.5" y2="8.5" gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#fff" stopOpacity={0} />
  ...
  <path fill="#949494" d="M9 18h3v3H9zm0 6h3v3H9zm0 6h3v3H9zm0 6h3v3H9zm0 6h3v3H9zm0 6h3v3H9zm0 6h3v3H9zm51-36h3v3h-3zm0 6h3v3h-3zm0 6h3v3h-3zm0 6h3v3h-3zm0 6h3v3h-3zm0 6h3v3h-3zm0 6h3v3h-3zM27 25v22l20-11-20-11z" />
