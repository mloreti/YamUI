...
export default class OneToc extends BaseIllustration {
  ...
  <rect width={4} height={1} x={6} y={12} fill="#949494" rx=".5" ry=".5" />
  <rect width={3} height={1} x={7} y={12} fill="#949494" rx=".5" ry=".5" />
  <path fill="#fff" d="M10 3h23v2h3v6h-3v26H10V3z" />
  <path fill="#949494" d="M33 3v2h3v6h-3v26H10V3h23m1-1H9v36h25V12h3V4h-3V2z" />
  <path fill="#c8c8c8" d="M20 15h8v1h-8zM20 18h8v1h-8zM20 12h8v1h-8z" />
  ...
  <path fill="#949494" d="M34 13h3v6h-3zM34 20h3v6h-3zM34 27h3v6h-3z" />
  <rect width={4} height={1} x={6} y={9} fill="#949494" rx=".5" ry=".5" />
  <rect width={4} height={1} x={6} y={6} fill="#949494" rx=".5" ry=".5" />
