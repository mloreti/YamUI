...
export default class Xsn extends BaseIllustration {
  ...
  <path fill="#6a3889" d="M3 11l13-2v18L3 25V11z" />
  <path fill="#fff" d="M10 22H8.5v-8H10z" />
  <path fill="#c8c8c8" d="M25 10h-9v1h9v3h-9v1h10v-5h-1zM25 16h-9v1h9v3h-9v1h10v-5h-1zM25 22h-9v1h9v3h-9v1h10v-5h-1z" />
