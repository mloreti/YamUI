...
export default class Multiple extends BaseIllustration {
  render() {
    return (
      ...
      >
        <defs>
    <linearGradient id="a" x1="11.231" x2="58.876" y1="8.002" y2="64.783" gradientUnits="userSpaceOnUse">
    ...
    <linearGradient id="c" x1="-4893.241" x2="-4938.921" y1="18.969" y2="77.437" gradientTransform="matrix(-1 0 0 1 -4895 0)" xlinkHref="#a" />
    <linearGradient id="d" x1={36} x2={36} y1="67.844" y2="63.146" xlinkHref="#b" />
  </defs>
  ...
  <path fill="url(#a)" d="M47 4H16v59h45V18z" />
  <path fill="url(#b)" d="M45 20h14v5H45z" />
  <path fill="url(#c)" d="M16 9v54h40v5H11V9h5z" />
  <path fill="url(#d)" d="M16 63h40v5H16z" />
      </svg>
    );
  }
}
