...
export default class FullFolder extends BaseIllustration {
  render() {
    return (
      ...
      >
        <defs>
    <linearGradient id="a" x1="29.589" x2="28.788" y1="6.264" y2="15.419" gradientUnits="userSpaceOnUse">
      <stop offset={0} stopColor="#828282" stopOpacity={0} />
      <stop offset=".859" stopColor="#454545" stopOpacity=".117" />
      <stop offset={1} stopOpacity=".25" />
    </linearGradient>
    <linearGradient id="b" x1="6.162" x2="31.869" y1="7.508" y2="38.145" gradientUnits="userSpaceOnUse">
  ...
  <path fill="url(#a)" d="M24 7l-4 4 4 4h14V7H24z" />
  ...
  <path fill="url(#b)" d="M2 33V11h18l4 4h14v18H2z" />
      </svg>
    );
  }
}
